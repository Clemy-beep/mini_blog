    ...
    <div class="menu">
        ...
        <div class="menuitem1" id="droptest">
            ...
            <ul id="articles-section">
                <li><a href="../articles/articles_list.php">All articles</a></li>
                <li><a href="../articles/users_articles.php">My articles</a></li>
                <li><a href="../articles/categories.php">Categories</a></li>
            </ul>
        </div>
